...
predictions_train = naive_bayes.predict(x_training_data)
predictions_test = naive_bayes.predict(testing_data)

"""**evaluation of model**"""

from sklearn.metrics import accuracy_score, confusion_matrix
acc_score_train = accuracy_score(predictions_train,y_train)
print("accuracy_score_training:",acc_score_train)
acc_score_test = accuracy_score(predictions_test,y_test)
print("accuracy_score_testing:",acc_score_test)
cm_score = confusion_matrix(predictions,y_test)
print("cm_score: \n {}".format(cm_score))

"""**building a dictionary from above pre_processed doc**"""
...
"""**Filter out tokens that appear in <15 D**"""
...
lda_model = gensim.models.LdaMulticore(corpus = bow_corpus, num_topics=4, id2word=dictionary, passes=2, workers=4, per_word_topics = True, chunksize=10000)
...
lda_model_tfidf = gensim.models.LdaMulticore(corpus = corpus_tfidf, num_topics=4, id2word=dictionary, passes=2, workers=4, per_word_topics = True, chunksize=1000)
...
processed_docs[179607]

for index, score in sorted(lda_model[bow_corpus[179607]], key=lambda tup: -1*tup[1]):
